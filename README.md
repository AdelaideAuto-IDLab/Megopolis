...
Chesser J., Nguyen H. V., & Damith C. (2021). *The Megopolis Resampler: Memory Coalesced Resampling on GPUs*.  Which is accepted to [Digital Signal Processing](https://www.journals.elsevier.com/digital-signal-processing/). 
